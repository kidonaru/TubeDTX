...
TubeDTXは、YouTubeからDTX譜面を作成するアプリケーションです。
...
1. プレビュー音声ファイルの作成
   ...
   - "Auto Create"ボタンを押して、サビ時間を推定してプレビュー用の音声ファイルを作成します
...
NVIDIAのGPUを使用している場合はGPU版もインストール可能ですが、オススメはしません。
